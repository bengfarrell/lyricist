...
export class SongStoreController implements ReactiveController {
  ...
  get showWordLadderConfig(): boolean {
    return songStore.showWordLadderConfig;
  }
  ...
  get canvasPanX(): number {
    return songStore.canvasPanX;
  }

  get canvasPanY(): number {
    return songStore.canvasPanY;
  }

  get isSpacebarPanMode(): boolean {
    return songStore.isSpacebarPanMode;
  }
  ...
  get wordLadderRandomColumnCount(): number {
    return songStore.wordLadderRandomColumnCount;
  }
  ...
  setShowWordLadderConfig(show: boolean): void {
    songStore.setShowWordLadderConfig(show);
  }
  ...
  setCanvasPan(x: number, y: number): void {
    songStore.setCanvasPan(x, y);
  }

  adjustCanvasPan(deltaX: number, deltaY: number): void {
    songStore.adjustCanvasPan(deltaX, deltaY);
  }

  setSpacebarPanMode(enabled: boolean): void {
    songStore.setSpacebarPanMode(enabled);
  }
  ...
  setWordLadderRandomColumnCount(count: number): void {
    songStore.setWordLadderRandomColumnCount(count);
  }
