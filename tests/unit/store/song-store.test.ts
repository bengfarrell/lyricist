...
describe('SongStore', () => {
  ...
  // Note: Word Ladder functionality is comprehensively tested in word-ladder.test.ts
  // These legacy tests have been removed in favor of the new column-based architecture tests
});
